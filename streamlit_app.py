# =============================================================================
# DEPRECATED — This Streamlit frontend has been replaced by the React frontend
# located in the `frontend/` directory.
#
# To run the new frontend:
#   cd frontend && npm install && npm run dev
#
# This file is kept for reference only and is NOT part of the active application.
# =============================================================================
